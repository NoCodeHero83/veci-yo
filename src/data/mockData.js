...
export const visitasItems = [
  ...
  },
  {
    ...
    esEvento: false,
    invitados: [
      { nombre: 'Diego Villalobos', llego: false, aprobado: 'pendiente', esMenor: true, documentos: ['cedula-anverso', 'tutela'], tieneTutela: true, traSireReported: false, tipoDocumento: 'Cédula', documentoNumero: '1700099988', fechaNacimiento: '14/07/2010', timeline: { preregistroEnviado: true, documentacionCompleta: true, terminosAceptados: null, verificacionPasada: false, verificacionHallazgos: null, verificacionAprobada: false, trasideEntrada: null, trasideSalida: null } },
      { nombre: 'Sofía Villalobos', llego: false, aprobado: 'pendiente', esMenor: true, documentos: [], tieneTutela: false, traSireReported: false, terminosExcepcion: true, tipoDocumento: 'Pasaporte', documentoNumero: 'AB123456', fechaNacimiento: '22/11/2015', timeline: { preregistroEnviado: true, documentacionCompleta: true, terminosAceptados: null, terminosAprobadoPor: null, verificacionPasada: false, verificacionHallazgos: false, verificacionAprobada: false, trasideEntrada: null, trasideSalida: null } },
...
export const ingresosSalidasHoy = [
  ...
  { id: 4,  nombre: 'Carlos Mendoza',        tipo: 'Huésped temporal', depto: '105', horaIngreso: '10:30', horaSalida: '14:30', estado: 'Ingresó' },
  { id: 5,  nombre: 'Lucía Torres',          tipo: 'Huésped temporal', depto: '105', horaIngreso: '11:00', horaSalida: '15:00', estado: 'Ingresó' },
  { id: 6,  nombre: 'Roberto Andrade',       tipo: 'Visitante',        depto: '201', horaIngreso: '09:00', horaSalida: '13:00', estado: 'Ingresó' },
  { id: 7,  nombre: 'Ana María Silva',       tipo: 'Visitante',        depto: '201', horaIngreso: '09:30', horaSalida: '13:30', estado: 'Ingresó' },
  { id: 8,  nombre: 'Carmen Villalobos',     tipo: 'Huésped temporal', depto: '301', horaIngreso: '14:00', horaSalida: '18:00', estado: 'Ingresó' },
  { id: 9,  nombre: 'Diego Villalobos',      tipo: 'Visitante',        depto: '301', horaIngreso: '14:30', horaSalida: '18:30', estado: 'Ingresó' },
